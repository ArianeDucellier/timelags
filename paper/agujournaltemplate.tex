...
The median of the tremor depth minus the plate model is 1.92 km for the McCrory model and 1.8 km for the Preston model, while the Qn estimator of scale for these models is 1.39 and 1.31 km. So, to a very good approximation,  the tremor appears to coincide with the plate boundary.
