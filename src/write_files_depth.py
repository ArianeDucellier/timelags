...
np.savetxt('map_depth/section_strike_{}_{}_1.txt'.format(type_stack, cc_stack), section_strike_1, fmt='%10.5f')
np.savetxt('map_depth/section_strike_{}_{}_2.txt'.format(type_stack, cc_stack), section_strike_2, fmt='%10.5f')
np.savetxt('map_depth/section_strike_{}_{}_3.txt'.format(type_stack, cc_stack), section_strike_3, fmt='%10.5f')
